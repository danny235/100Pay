...
export type BasePinT = {
  onContinuePress: (code: string) => void;
};

export default function EnterOldPin({ onContinuePress }: BasePinT) {
  ...
  return (
    <View className="space-y-3 px-5 py-3 flex-1 mt-5">
      <Pressable onPress={handleOnPress} className=" flex-row mb-auto items-center justify-center space-x-4">
